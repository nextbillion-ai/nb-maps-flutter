...
class LayerPropertyConverter {
    class func addSymbolProperties(symbolLayer: NGLSymbolStyleLayer, properties: [String: String]) {
    ...
    class func addCircleProperties(circleLayer: NGLCircleStyleLayer, properties: [String: String]) {
        for (propertyName, propertyValue) in properties {
            let expression = interpretExpression(
                propertyName: propertyName,
                expression: propertyValue
    ...
    class func addLineProperties(lineLayer: NGLLineStyleLayer, properties: [String: String]) {
        for (propertyName, propertyValue) in properties {
            let expression = interpretExpression(
                propertyName: propertyName,
                expression: propertyValue
    ...
    class func addFillProperties(fillLayer: NGLFillStyleLayer, properties: [String: String]) {
        for (propertyName, propertyValue) in properties {
            let expression = interpretExpression(
                propertyName: propertyName,
                expression: propertyValue
    ...
    class func addHillshadeProperties(
        hillshadeLayer: NGLHillshadeStyleLayer,
        properties: [String: String]
    ) {
        for (propertyName, propertyValue) in properties {
            let expression = interpretExpression(
    ...
    class func addHeatmapProperties(
        heatmapLayer: NGLHeatmapStyleLayer,
        properties: [String: String]
    ) {
        for (propertyName, propertyValue) in properties {
            let expression = interpretExpression(
                                           ...
                                           expression: String) -> NSExpression?
    {
        ...
        do {
            ...
            return NSExpression(nglJSONObject: json)
        } catch {}
        return nil
    }
}
