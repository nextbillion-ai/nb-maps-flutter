...
class NextbillionMapController extends ChangeNotifier {
  ...
  Future<bool?> animateCamera(CameraUpdate cameraUpdate,
    ...
    return await _nbMapsGlPlatform.animateCamera(cameraUpdate,
        duration: duration);
  }
  ...
  Future<void> updateMyLocationTrackingMode(
    ...
    return await _nbMapsGlPlatform
  ...
  Future<void> updateImageSource(
    ...
    return await _nbMapsGlPlatform.updateImageSource(
        imageSourceId, bytes, coordinates);
  }
  ...
  Future<void> addImageLayer(String layerId, String imageSourceId,
    ...
    return await _nbMapsGlPlatform.addLayer(
  ...
  Future<void> addImageLayerBelow(
    ...
    return await _nbMapsGlPlatform.addLayerBelow(
