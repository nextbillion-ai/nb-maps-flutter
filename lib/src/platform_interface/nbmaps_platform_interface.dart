...
abstract class NbMapsGlPlatform {
  /// The default instance of [NbMapsGlPlatform] to use.
  ///
  /// Defaults to [MethodChannelNbMapsGl].
  ///
  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [NbMapsGlPlatform] when they register themselves.
  static NbMapsGlPlatform Function() createInstance =
